...
[문제 보러 가기](https://www.acmicpc.net/problem/14503)

## 요약

> 로봇 청소기와 방의 상태가 주어졌을 때, 청소하는 영역의 개수를 구하는 프로그램을 작성하시오.

> 로봇 청소기가 있는 방은 $N \times M$ 크기의 직사각형으로 나타낼 수 있으며, $1 \times 1$ 크기의 정사각형 칸으로 나누어져 있다.  
...
입력 및 출력 예시는 [문제 링크](https://www.acmicpc.net/problem/14503) 참고.

### 문제풀이

이동 순서대로 작성

continue를 사용해서, 하나라도 작동했으면 다시 처음부터 수행

만약 4방향이 모두 막혀있고, 이동이 불가하지 않다면, 뒤로 이동하도록 수행

뒤로 이동하는 경우 -> direction[d]가 앞으로 이동하는 것이므로 이만큼의 값을 빼서 뒤로 가기를 수행한다.
